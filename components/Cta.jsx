...
const TEXT_ITEMS = [
  { id: "badge", start: 0.1 },
  { id: "heading", start: 0.2 },
  { id: "sub", start: 0.35 },
  { id: "btn", start: 0.5 },
  { id: "contact", start: 0.6 },
];
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(180,16,29,0.06) 1px, transparent 1px), linear-gradient(90deg, rgba(180,16,29,0.06) 1px, transparent 1px)",
      ...
      <div
        ...
        style={{
          ...
          height: "50vw",
          background:
            "radial-gradient(circle, rgba(179,14,28,0.12) 0%, transparent 65%)",
          filter: "blur(60px)",
        }}
      />
      <div
        ...
        style={{
          ...
          height: "45vw",
          background:
            "radial-gradient(circle, rgba(179,14,28,0.08) 0%, transparent 65%)",
          filter: "blur(70px)",
        }}
      />
      ...
      {/* Glow rings */}
      <div
        className="pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full border border-[#b4101d]/[0.08]"
        style={{ width: "80vw", height: "80vw", maxWidth: 900, maxHeight: 900 }}
      />
      <div
        className="pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full border border-[#b4101d]/[0.05]"
        style={{ width: "55vw", height: "55vw", maxWidth: 650, maxHeight: 650 }}
      />

      {/* Main layout — stacked on mobile, side-by-side on desktop */}
      <div
        className="relative z-10 flex flex-col lg:flex-row h-full w-full items-center px-6 md:px-12 lg:px-24 py-20 lg:py-0 gap-10 lg:gap-16"
        style={{ minHeight: "100vh" }}
      >
        {/* Video */}
        <div
          className="w-full lg:flex-shrink-0 lg:w-[55%] flex items-center justify-center"
          style={{ maxWidth: 800 }}
        >
          <video
            ref={videoRef}
        ...
        <div className="w-full lg:flex-1 flex flex-col items-start justify-center min-w-0">
          ...
          >
            <span
              className="h-[7px] w-[7px] rounded-full bg-[#B30E1C] animate-pulse"
              aria-hidden="true"
            />
            Take the Next Step
          </div>
          ...
          >
            ...
            <span
              style={{
                color: "#B30E1C",
                textShadow: "0 0 40px rgba(179,14,28,0.5)",
              }}
            >
              Forge
            </span>{" "}
          ...
          >
            Join the dealerships already running on the most advanced AI
            platform in the industry. Most stores are live inside 30 days.
          </p>
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 90% 80% at 50% 50%, transparent 30%, rgba(5,5,7,0.6) 100%)",
        }}
      />
    </section>
  );
